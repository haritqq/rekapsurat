...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h5>Table SKMTA</h5>
        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalTambah">+ Tambah SKMTA</button>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <?php
                $no = 1;
                $query = mysqli_query($koneksi, "SELECT * FROM skmta ORDER BY id DESC");
                ...
                <tr>
                    ...
                    <td class="d-flex flex-wrap justify-content-center align-items-center gap-2"> 
                        ...
                        <a href="proses_surat.php?act=hapus_skmta&id=<?= $data['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus?')"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
                ...
                <div class="modal fade" id="modalEdit<?= $data['id']; ?>" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="proses_surat.php?act=edit_skmta">
...
<div class="modal fade" id="modalTambah" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="proses_surat.php?act=tambah_skmta">
            <div class="modal-body">
