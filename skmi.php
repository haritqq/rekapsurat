...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h5>Table SKMI</h5>
        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalTambah">+ Tambah SKMI</button>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <?php
                $no = 1;
                $query = mysqli_query($koneksi, "SELECT * FROM skmi ORDER BY id DESC");
                ...
                <div class="modal fade" id="modalEdit<?= $data['id']; ?>" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="proses_surat.php?act=edit_skmi">
...
<div class="modal fade" id="modalTambah" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="proses_surat.php?act=tambah_skmi">
            <div class="modal-body">
